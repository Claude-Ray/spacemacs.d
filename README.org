...
*** font
    ...
    #+end_src
    Moreover, for the GUI version, run =brew cask install font-sarasa-gothic= or install [[https://github.com/be5invis/Sarasa-Gothic][Sarasa Gothic]] manually to fix the problem about chinese font alignment in org-table.
*** Input Method
